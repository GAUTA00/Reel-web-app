...
import { ArrowLeft, Heart, MessageCircle, UserPlus, Check } from 'lucide-react';
            ...
            <div className="space-y-4">
                {loading ? (
                    ...
                    notifications.map(n => (
                        <div
                            key={n._id}
                            className={`flex items-start gap-4 p-4 rounded-xl transition ${n.read ? 'bg-transparent opacity-60' : 'bg-gray-900 border border-gray-800'}`}
