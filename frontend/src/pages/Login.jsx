    ...
    return (
        <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-6 font-sans">
            ...
            <div className="mb-12 text-center animate-fade-in">
                <h2 className="font-serif text-4xl mb-4 tracking-tight">Login</h2>
                <p className="text-gray-500 text-sm tracking-wide">ENTER YOUR CREDENTIALS TO CONTINUE</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="w-full max-w-sm flex flex-col gap-8 animate-slideUp">
                ...
                <div className="flex items-center gap-4 my-2">
                    ...
                    <span className="text-[10px] text-gray-700 uppercase">Or</span>
                    <div className="h-px bg-gray-900 flex-1" />
                </div>
                ...
                <button
                    ...
                    className="w-full border border-gray-800 text-gray-400 font-bold text-xs py-4 tracking-widest hover:border-gray-600 hover:text-white transition-all flex items-center justify-center gap-3"
                >
